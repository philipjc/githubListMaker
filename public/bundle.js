...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	<RouteHandler /> will be swapped out and replaced with which ever child path
	we hit in route.js.

	<RouteHandler {...this.props} /> - Continuing to pass down the props from App.js
	...state spread operator. So each Route can access the props.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = _reBase2['default'].createClass('https://brilliant-torch-5076.firebaseio.com');
	...
	var Profile = (function (_React$Component) {
	  ...
	  _createClass(Profile, [{
	    ...
	    value: function init() {
	      ...
	      _utilsHelpers2['default'].getGithubInfo(this.router.getCurrentParams().username).then(function (dataObject) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: "col-md-4" },
	          _react2['default'].createElement(_GithubUserProfile2['default'], {
	            username: username,
	            bio: this.state.bio
	          })
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: "col-md-4" },
	          _react2['default'].createElement(_GithubRepos2['default'], {
	            username: username,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NotesCollection = __webpack_require__(202);

	var _NotesCollection2 = _interopRequireDefault(_NotesCollection);
	  ...
	  _createClass(Notes, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_NotesCollection2['default'], {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RemoveNote = __webpack_require__(203);
	      ...
	      var notes = this.props.notes.map(function (note, index) {
	        return _react2['default'].createElement(
	          'li',
	          {
	            ...
	            key: index },
	          note,
	          _react2['default'].createElement(_RemoveNote2['default'], null)
	        );
	      });
	      return _react2['default'].createElement(
	        'ul',
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	  Because not all Githib accouts have these properties, we perform the IF statement syntax.

	  Checks if the IF's are truethy, if they are, render them to the screen.
	*/
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	Tricky way to do IF statements in JS.
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if(true)
			module.exports = factory(__webpack_require__(229));
